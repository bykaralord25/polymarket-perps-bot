...
if(path==="/api/health"){res.writeHead(200,{"content-type":"application/json","cache-control":"no-store"});res.end(JSON.stringify({ok:true,version:"0.8.0",execution:"paper-only"}));return}
